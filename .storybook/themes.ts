...
function lightTheme() {
  const theme = create({
    base: 'light',
    colorSecondary: '#00adef', // blue(500),
    appBg: '#eef1f4', //slate(50),
    appContentBg: white,
    appBorderColor: rgba(black, 0.1),
    textColor: grayscale(900),
    textInverseColor: '#eef1f4', //slate(50),
    barBg: white,
    barTextColor: grayscale(500),
    barSelectedColor: '#00adef', // blue(500),
    inputBg: white,
...
function darkTheme() {
  const theme = create({
    base: 'dark',
    colorSecondary: '#4cbdf3', // blue(350),
    appBg: black,
    ...
    barBg: grayscale(950),
    barTextColor: '#eef1f4', //slate(50),
    barSelectedColor: '#4cbdf3', // blue(350),
    inputBg: black,
