...
interface DataSpacer {
  height: number;
  spacer: true;
}

type Data = (DataCaption | DataSpacer)[];

export function mockTranscriptSegments(number = 500) {
  let seconds = 0;
