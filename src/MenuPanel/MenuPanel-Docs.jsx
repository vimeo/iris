    ...
    render() {
        ...
        const MenuWithActionArea = (
            ...
            >
                ...
                <ParagraphMd>
                    ...
                    he sought -- So rested he by the Tumtum tree, And stood
                    awhile in thought.
                </ParagraphMd>
                <ParagraphMd>
        ...
        return (
            <div className="Pattern__docs">
                <ParagraphMd>
                    Menu Panels provide a drop-down menu panel that can be
                    attached at different points using the{' '}
                    <code>alignment</code> prop.
                </ParagraphMd>
                <ParagraphMd>
                    Menu Panel content is passed to the <code>menuContent</code>{' '}
                    prop. The most common content will be the{' '}
                    <LinkText href="/pattern/Components/MenuPanelList">
                        MenuPanelList component
                    </LinkText>
                    .
                </ParagraphMd>
                <ParagraphMd>
                    The <code>onOpen</code> and <code>onClose</code> props take
                    callback functions that will fire when the menu opens or
                    closes.
                </ParagraphMd>
                <NotificationWarning>
                    <ParagraphMd>
                        The element passed to the component as child must not,
                        itself be interactive.
                    </ParagraphMd>
                    <List>
                        <ListItem>
                            If you use a button, use the{' '}
                            <code>isButtonElement=false</code> and{' '}
                            <code>isInline</code> prop flags.
                        </ListItem>
                        <ListItem>
                            If you are passing a bit of text formatted by the
                            LinkText component, use <code>element="span"</code>
                        </ListItem>
                    </List>
                </NotificationWarning>
                <div data-code>
                    ...
                    <ParagraphMd>
                        To get a dark theme apply <code>theme="dark</code> to
                        the MenuPanel component, and also to the MenuPanelList
                        component if you are using it.
                    </ParagraphMd>
                    ...
                    <ParagraphMd>
                        To add a scrollable area with action buttons to a menu
                        panel use the{' '}
                        <code>MenuPanelScrollableWithActionArea</code> as the
                        menu panel content. See the documentation for this
                        component for prop information.
                    </ParagraphMd>
                    <div className={styles.Spacer}>
...
>
    ...
    />
                ...
                `}
                    ...
                    <div className={styles.Spacer}>
                        <ParagraphMd>
                            If you need the trigger "button" to appear full
                            width you need to both apply the{' '}
                            <code>isFluid</code> prop to the menu panel{' '}
                            <strong>and</strong> the{' '}
                            <code>autoWidth="fluid"</code>
                            prop to the button.
                        </ParagraphMd>
                        <MenuPanel
                            alignment="center"
...
>
    ...
    >
        Click for Medium Center Menu
                    ...
                    <Header3>
                        Controlling Open/Close with the isShowing Prop
                    </Header3>
                    <ParagraphMd>
                        MenuPanels will often be controlled by their parent
                        using state. The button below toggles the{' '}
                        <code>isShowing</code> prop on the menu above.
                    </ParagraphMd>
                    <Button
