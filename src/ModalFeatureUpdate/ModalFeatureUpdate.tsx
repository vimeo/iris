...
const ModalFeatureUpdateStyled = styled<ModalFeatureUpdateStyledProps, 'div'>(
    ...
    max-width: ${rem(380)};
    width: calc(100% - ${rem(ModalFeatureUpdateStyleSettings.modalMargin * 2)});
    max-height: calc(
...
interface ButtonDialogCloseStyledProps
...
class ModalFeatureUpdate extends React.Component<any, any> {
