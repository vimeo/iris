...
export const SearchEmptystate = (props: SVGProps<SVGSVGElement>) => (
    <svg viewBox="0 0 176 82" {...props}>
        <path
            ...
            fill="#8699a6"
        />
        <circle cx={84.5} cy={39.5} r={11.5} fill="#8699a6" />
        <path d="M22 26a3 3 0 1 1 3 3 3 3 0 0 1-3-3" fill="#8699a6" />
        <path
