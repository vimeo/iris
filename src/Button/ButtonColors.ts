...
export const ButtonColors = {
    ...
    SuccessBackgroundActive: darken(0.1, VimeoStyleSettings.colors.uiColors.successColorHover),
    SuccessBackgroundHover: VimeoStyleSettings.colors.uiColors.successColorHover,

    WarningBackground: VimeoStyleSettings.colors.uiColors.alertColor,
    WarningBackgroundActive: darken(0.1, VimeoStyleSettings.colors.uiColors.alertColorHover),
