...
storiesOf(`components|Badges`, module).add('Badge', () => (
  <Story title="Badge">
    ...
    <Badge href="#" format="alum" size={select('size', sizes, 'sm')}>
      alum
    </Badge>
    <Badge href="#" format="beta" size={select('size', sizes, 'sm')}>
      beta
    </Badge>
    <Badge
      href="#"
    ...
    <Badge href="#" format="info" size={select('size', sizes, 'sm')}>
      info
    </Badge>
    <Badge href="#" format="live" size={select('size', sizes, 'sm')}>
      live
    </Badge>
    <Badge
      href="#"
    ...
    <Badge href="#" format="plus" size={select('size', sizes, 'sm')}>
      plus
    </Badge>
    <Badge
      href="#"
    ...
    <Badge href="#" format="staff" size={select('size', sizes, 'sm')}>
      staff
    </Badge>
    <Badge
      href="#"
