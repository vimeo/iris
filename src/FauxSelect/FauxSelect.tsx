...
export interface FauxSelectProps extends InputProps, Omit<React.HTMLProps<HTMLButtonElement>, 'label' | 'size' | 'id'>  {
    /**
...
export interface FauxSelectStyledProps extends Omit<FauxSelectProps , 'a11yLabel'>  {
    hasIcon?: boolean;
    hasInlineIcon?: boolean;
};
