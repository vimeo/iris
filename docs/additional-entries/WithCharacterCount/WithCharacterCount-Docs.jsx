...
import withCharacterCounter from '../../../src/withCharacterCount/withCharacterCount';

const InputTextWithCharacterCount = withCharacterCounter(InputText);
const TextAreaWithCharacterCount = withCharacterCounter(TextArea);
...
const WithCharacterCountDocs = props => (
    <div className="Pattern__docs">
        <div data-code>
            <ParagraphMd>
                The <code>withCharacterCount()</code> helper is a HOC that adds
                a character count to InputText and TextArea.
            </ParagraphMd>
            ...
            <List>
                ...
                <ListItem>
                    The <code>maxCharacters</code> prop is a required indicator
                    specifying the max character count.
                </ListItem>
                <ListItem>
                    The <code>warningThreshold</code> is an optional interger
                    that indicates when the counter should go into a "warning"
                    state to let the user know they are reaching the limit of
                    the character count. It will default to 5 if nothing is
                    provided.
                </ListItem>
                <ListItem>
            ...
            <TextAreaWithCharacterCount
                label="TextArea with character count and warning threshold at 10 characters"
                maxCharacters={30}
                warningThreshold={10}
                characterSingularString="character"
                characterPluralString="characters"
