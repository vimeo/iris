...
import { VerticalMenuItem, VerticalMenuItemContent } from '../../src/index';
...
const NavigationLinkStyled = styled(({ index, ...rest }) => (
    <VerticalMenuItem {...rest} />
))`
...
export const NavigationLink = props => (
    <NavigationLinkStyled index={props.index}>
        <Link to={props.linkPath}>
            <VerticalMenuItemContent label={props.linkText} />
        </Link>
